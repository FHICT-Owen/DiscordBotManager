...
module.exports = {
  ...
  run: async (client, message) => {
    try {
      ...
      const title = await message.channel.awaitMessages(filter, options);
      ...
      const Description = await message.channel.awaitMessages(filter, options);
      ...
      const Footer = await message.channel.awaitMessages(filter, options);
      ...
      const Color = await message.channel.awaitMessages(filter, options);
      ...
      const Author = await message.channel.awaitMessages(filter, options);
      ...
      const TimeStamp = await message.channel.awaitMessages(filter, options);
